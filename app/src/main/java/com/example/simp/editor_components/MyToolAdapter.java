...
import com.example.simp.editor_components.dialog.UserHelpDialog;
...
//        Add the data to the view holder
        TypedArray imgs = mContext.getResources().obtainTypedArray(R.array.icon_list);
        holder.ivIcon.setImageResource(imgs.getResourceId(position%initialListItemSize,0));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            ivIcon = itemView.findViewById(R.id.iv_tool);
        }
    }
